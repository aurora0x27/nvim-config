...
local icons = {
    kind = require 'assets.icons'.get('kind', true),
    type = require 'assets.icons'.get('type', true),
    misc = require 'assets.icons'.get('misc', true),
    ui = require 'assets.icons'.get('ui', true),
}
            ...
            sources = {
                terminal = {
                    name = function(buf)
                        ...
                        local term = select(
                            2,
                            require 'toggleterm.terminal'.identify(name)
                        )
