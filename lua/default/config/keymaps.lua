...
function keymaps.apply()
    ...
    -- buffer swich
    vim.keymap.set("n", "<C-h>", ":SmartCursorMoveLeft<Enter>",
        { desc = "Move to left window", noremap = true, silent = true })
    vim.keymap.set("n", "<C-j>", ":SmartCursorMoveDown<Enter>",
        { desc = "Move to below window", noremap = true, silent = true })
    vim.keymap.set("n", "<C-k>", ":SmartCursorMoveUp<Enter>",
        { desc = "Move to above window", noremap = true, silent = true })
    vim.keymap.set("n", "<C-l>", ":SmartCursorMoveRight<Enter>",
    ...
    vim.keymap.set("n", "<Leader>fo", ":Telescope oldfiles<Enter>",
        { desc = "Telescope Find Recent Files", noremap = true, silent = true })
    vim.keymap.set("n", "<Leader>fw", ":Telescope live_grep<Enter>",
    ...
    vim.keymap.set("n", "<Leader>fd", ":Telescope diagnostics<Enter>",
        { desc = "Telescope Find Diagnostics", noremap = true, silent = true })
    vim.keymap.set("n", "<Leader>fg", ":Telescope git_status<Enter>",
    ...
    vim.keymap.set("n", "<Leader>bl", ":Telescope buffers<Enter>",
    ...
    vim.keymap.set("n", "<Leader>lg", ":Telescope git_commits<Enter>",
        { desc = "Search Git Commits", noremap = true, silent = true })
    vim.keymap.set("n", "<Leader>lD", ":Telescope diagnostics<Enter>",
